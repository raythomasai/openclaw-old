...
// British male voice configuration for Hume AI
const BRITISH_MALE_VOICE = {
  id: '9e1f9e4f-691a-4bb0-b87c-e306a4c838ef',
  speed: 1.0,
  pitch: 0.5,
  volume: 1.0
};
...
async function main() {
  ...
  try {
    console.log(`Generating British male voice speech via Hume AI for: "${options.text.substring(0, 50)}..."`);
